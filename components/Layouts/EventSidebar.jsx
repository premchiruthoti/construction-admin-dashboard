          ...
          <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
            <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
              ...
              <li className="nav-item">
                <ul>
                  <li className="nav-item">
                    <Link
                      href={{
                        pathname: "/[events]/manage-editions",
                  ...
                  <li className="menu nav-item">
                    ...
                    <AnimateHeight
                      duration={300}
                      height={currentMenu === "media" ? "auto" : 0}
                    >
                      <ul className="sub-menu text-gray-500">
                        <li>
                          <Link
                            href={{
                              pathname: "/[events]/view-library",
                              query: { events: eventSlug },
                            }}
                          >
                            View Library
              ...
              <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                ...
                <span>Logos, Banners & Images</span>
              </h2>
              ...
              <li className="menu nav-item">
                <button
                  type="button"
                  className={`${
                    currentMenu === "manage-images" ? "active" : ""
                  } nav-link group w-full`}
                  onClick={() => toggleMenu("manage-images")}
                >
                  <div className="flex items-center">
                    <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">
                      Manage Images
                ...
                <AnimateHeight
                  duration={300}
                  height={currentMenu === "manage-images" ? "auto" : 0}
                >
                  <ul className="sub-menu text-gray-500">
                    <li>
                      <Link
              ...
              <li className="menu nav-item">
                ...
                >
                  ...
                  <div
                    className={
                      currentMenu === "users" ? "rotate-90" : "rtl:rotate-180"
                    }
                  >
                    <svg
                      width="16"
              ...
              <li className="menu nav-item">
                ...
                >
                  ...
                  <div
                    className={
                      currentMenu === "page" ? "rotate-90" : "rtl:rotate-180"
                    }
                  >
                    <svg
                      width="16"
              ...
              <li className="menu nav-item">
                ...
                >
                  ...
                  <div
                    className={
                      currentMenu === "auth" ? "rotate-90" : "rtl:rotate-180"
                    }
                  >
                    <svg
                      width="16"
