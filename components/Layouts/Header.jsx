    ...
    >
      <div className="shadow-sm">
        <div className="relative flex w-full  items-center justify-between bg-white px-5 py-2.5 dark:bg-black">
          ...
          <div className="flex items-center justify-end space-x-1.5 sm:flex-1 lg:space-x-2 ltr:ml-auto ltr:sm:ml-0 rtl:mr-auto rtl:space-x-reverse sm:rtl:mr-0 dark:text-[#d0d2d6]">
                  ...
                  <li>
                    <div className="flex items-center px-4 py-4">
                      ...
                      <div className="truncate ltr:pl-4 rtl:pr-4">
                        <h4 className="text-base">{adminName}</h4>
                      </div>
                    </div>
                  </li>
                  <li>
