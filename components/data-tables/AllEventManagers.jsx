...
function AllEventManagersTable() {
  const [rowData, setRowData] = useState([]);

  useEffect(() => {
    const getAllEventsData = async () => {
      const response = await fetch(
        "http://localhost:4000/api/events/add-event-manager",
        {
          method: "GET",
          headers: {
    ...
    setInitialRecords(() => {
      return rowData.filter((item) => {
        return (
          ...
          item.event_slug.toLowerCase().includes(search.toLowerCase()) ||
          ...
          <div className="datatables">
            <DataTable
              ...
              columns={[
                ...
                { accessor: "user_name", title: "Username", sortable: true },
                { accessor: "event_slug", title: "Event Slug", sortable: true },
                {
                  accessor: "created_at",
                  title: "Created at",
                  sortable: true,
...
export default AllEventManagersTable;
